 ...
 * @subpackage Renderer
 */
class Default_Renderer_Nexus_Helper_FormatShip extends Zend_View_Helper_Abstract
{
    ...
    {
        if (null === $fleet) {
            return "[color=#ff6600]{$this->view->translate($ship->getName())} {$this->view->formatNumber($ship->getCount())}[/color]\n";
        } else {
            /*
