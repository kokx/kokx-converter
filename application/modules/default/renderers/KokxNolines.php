 ...
 * @subpackage Renderer
 */
class Default_Renderer_KokxNolines extends Default_Renderer_RendererAbstract
{
    ...
    {
        return 'Default_Renderer_KokxNolines';
    }
    ...
    {
        return dirname(__FILE__) . DIRECTORY_SEPARATOR . 'kokx-nolines';
    }
}
